...
if(isset($_GET['id'])){	
	...
	//Use the var to check to see if this ID exists,if yes then get the category
		$categoryID=$id;
		$sql=mysql_query("SELECT * FROM categories WHERE CATEGORY_ID='$categoryID'");
...
$dynamicView1="";
$i=1;
$sql4=mysql_query("SELECT * FROM complaints WHERE CATEGORY='$id' AND STATUS!='solved'");
...
<div id="header-wrap"><header>
    ...
    <div id="content" class="clearfix">
        ...
        <img src="images/tag3.png" width="724" usemap="#Map"/>
        <map name="Map">
          <area shape="rect" coords="295,7,421,44" alt="solved" href="category2.php?id=<?php echo $categoryID;?>">
